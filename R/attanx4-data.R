...
#'   \item perceiver.id An indicator for the rater in the dyad, either "m", "f", "c", or "y"
#'   \item target.id An indicator for the person being rated in the dyad, either "m", "f", "c", or "y"
