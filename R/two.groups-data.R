...
#'   \item neg1 First negativity measure.
#'   \item neg2 Second negativity measure.
#' }
#' 
#' @references Eichelsheim, V. I., Buist, K. L., Dekovic, M., Cook, W. L., Manders, W., Branje, S. J. T., et al. (2011). Negativity in problematic and nonproblematic families: a multigroup social relations model analysis with structured means.  \emph{Journal of family psychology : JFP : journal of the Division of Family Psychology of the American Psychological Association (Division 43)}, 25 (1), 152–6. DOI: 10.1037/a0022450 .
